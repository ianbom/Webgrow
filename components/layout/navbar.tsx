...
export function Navbar() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      const isOverDarkSection = Array.from(document.querySelectorAll<HTMLElement>("[data-navbar-tone='dark']")).some((section) => {
